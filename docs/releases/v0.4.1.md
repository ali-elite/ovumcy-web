...
- Recorded the Chromium date-input accessibility invariant in the repository testing guidance to keep future locale work on the shared date-field pattern.
